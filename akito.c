...
void akito(FILE* socket_stream, char uri[128]) {
    ...
    if(strstr(uri, "akito.jpg") != NULL) {
        printf("Image request: \n");

        FILE* img_file = fopen("assets/akito.jpg", "r");
    ...
    char* response_payload = "<!DOCTYPE html><html><head><title>Akito Server</title></head><body><style>* { background-color: #0ff; }</style><h1>Hi, I'm Akito!</h1><img src='akito.jpg' width='500'></body></html>"; 
    fprintf(socket_stream, "HTTP/1.1 200 OK"); 
